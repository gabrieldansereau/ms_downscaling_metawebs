...
We added more information on the size and content of the Canadian mammal metaweb relevant to this manuscript (**LXYZ**). We would however like to point out that we are not creating the metaweb here, but only re-using the one produced by Strydom et al. (2022). The metaweb is available alongside their manuscript.
